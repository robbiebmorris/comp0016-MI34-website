...
const abstract = {
  ...
  <br/><br/>
  Our team developed a solution to this problem that would empower disabled individuals and hospital patients to interact with technology seamlessly. Through MotionInput for Android, we devised a versatile Bluetooth controller setup that enables users to control a TV or any Bluetooth-enabled device hands-free, utilising a variety of input methods such as eye gaze, facial movements, and more. By leveraging this technology, users can navigate through interfaces, access entertainment, and engage with digital content with unprecedented ease and comfort, with a significantly larger set of compatible devices than before.
  <br/><br/>
  The culmination of our efforts is a fully functional Android application that is primed for deployment on the Android store. With MotionInput integrated to recognise both hand and facial gestures, and upcoming compatibility with eye gaze technology, our solution promises to revolutionise the accessibility landscape. Beyond the technical achievements, the real impact lies in the tangible difference it could make in the lives of countless individuals, offering them independence, convenience, and an enhanced quality of life.
  `
}
