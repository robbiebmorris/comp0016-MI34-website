...
function TeamMemberCard({ member }) {
  const testImage = 'test_image.png'; // Provide the path to your test image
  const member_image = {
    hugh: '@site/static/img/homepage/test_image.png',
    robbie: "",
    ulk: "" 
  }
  const team_members = {
  ...
  return (
    <div className={styles.teamMemberCard}>
      <div className={styles.card} style={{ width: '18rem' }}>
        <img className={styles.cardImage} src="https://via.placeholder.com/150" />
        <div className={styles.cardBody}>
          <h2 className={styles.cardTitle}>
            {team_members[member]}
          </h2>
          <div className={styles.icons}>
            <a href={team_member_links[member].github} className={styles.iconLink}><FontAwesomeIcon icon={faGithub} className={styles.icon} /></a>
            <a href={team_member_links[member].linkedIn} className={styles.iconLink}><FontAwesomeIcon icon={faLinkedin} className={styles.icon} /></a>
          </div>
